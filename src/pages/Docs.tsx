          ...
          <Card className="p-8 shadow-warm">
            ...
            <div className="aspect-video bg-black rounded-lg overflow-hidden">
              <video
                ...
                preload="metadata"
              >
                <source src="/demo_test.mp4" type="video/mp4" />
                Your browser does not support the video tag.
              </video>
            </div>
            <p className="text-sm text-muted-foreground mt-4 text-center">
              Watch the complete TreasuryDAO workflow: depositing ETH, creating proposals, and casting encrypted votes using FHE technology.
            </p>
          </Card>
        </section>
